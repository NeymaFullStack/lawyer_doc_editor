        ...
        <div className="space-y-4 p-6 sm:p-8 md:space-y-6">
          ...
          <FormProvider methods={methods} onSubmit={onSubmit}>
            <div className="w-[22rem] space-y-4 md:space-y-8">
              ...
              <button
                className="w-full rounded-lg bg-primary-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bg-slate-600"
                type="submit"
